  ...
  const AIKitSidebar = ({ items = [], activeItem, onItemClick, collapsed = false, onToggle, logo, title, className = '', ...props }) => {
    ...
    return React.createElement(React.Fragment, null,
      React.createElement('button', {
        ...
        // z-index above AIKitHeader's own `z-50` sticky bar (a tie loses to
        // DOM order, which put the header on top — confirmed live, the
        // trigger was rendered but unclickable, covered by the header).
