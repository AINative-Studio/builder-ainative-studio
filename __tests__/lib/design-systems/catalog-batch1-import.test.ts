...
/**
 * Batch 1 import (#595) — approval, chrome, cloud, concrete, console, context,
 * darkroom, delegate. Verifies the catalog entries transcribed into
...
describe.skipIf(!sourceDirExists)('DESIGN_SYSTEMS catalog — batch 1 transcription fidelity', () => {
