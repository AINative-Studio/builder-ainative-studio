...
/**
 * Batch 4 import (#595, FINAL batch) — pulse, raster, recall, router, signal,
 * sketchbook, stack, vinyl, washi, werkstatt, zero. Verifies the catalog
 * entries transcribed into lib/design-systems/catalog.ts are byte-identical
 * to the real theme.json files in the source asset drop, rather than
 * trusting hand-transcription.
 *
...
describe.skipIf(!sourceDirExists)('DESIGN_SYSTEMS catalog — batch 4 transcription fidelity', () => {
