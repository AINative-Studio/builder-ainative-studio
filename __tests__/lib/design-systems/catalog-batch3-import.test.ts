...
/**
 * Batch 3 import (#595) — kit, kowloon, latent, loop, marquee, marshmallow,
 * merge, orbit. Verifies the catalog entries transcribed into
...
describe.skipIf(!sourceDirExists)('DESIGN_SYSTEMS catalog — batch 3 transcription fidelity', () => {
