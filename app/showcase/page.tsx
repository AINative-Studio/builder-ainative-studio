  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black" data-agent-role="application" data-agent-context="showcase gallery of AI-generated React apps">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" data-agent-role="content">
        ...
        <section aria-label="Browse by category" className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {SHOWCASE_CATEGORIES.map(cat => (
              <span
                key={cat.id}
                className="px-3 py-1.5 text-sm font-medium bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-full text-gray-700 dark:text-gray-300 hover:border-blue-300 dark:hover:border-blue-600 cursor-pointer transition-colors"
              >
                {cat.label}
              </span>
            ))}
        ...
        {/* Seed apps */}
        <section aria-label="Curated showcase apps">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
            Curated Apps ({all.length})
          </h2>
        ...
        {/* Dynamic community-generated apps from API */}
        <section aria-label="Community generated apps" className="mt-12">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
            Community Creations
          </h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
            Apps generated by users — each built with a single prompt
          </p>
