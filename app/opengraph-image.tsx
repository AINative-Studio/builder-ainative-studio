...
export const alt = 'AINative Builder - AI-powered React component builder'
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '30px' }}>
          <svg width="80" height="80" viewBox="0 0 100 85" fill="none">
          ...
          <div style={{ fontSize: '64px', fontWeight: 700, color: 'white' }}>
            AINative Builder
          </div>
        </div>

        {/* Tagline */}
        <div style={{ fontSize: '28px', color: '#a0a0b0', marginBottom: '40px', textAlign: 'center' }}>
          AI-powered React component builder with AX optimization
        </div>

        {/* Feature pills */}
        <div style={{ display: 'flex', gap: '16px' }}>
          {['Claude Sonnet 4', 'Agent-Optimized', 'SEO + AX Built-in', 'Multi-Model'].map((f) => (
            <div
              key={f}
              style={{
                padding: '10px 24px',
                borderRadius: '999px',
                border: '1px solid #5867EF40',
                background: '#5867EF15',
                color: '#8890ff',
                fontSize: '18px',
              }}
        ...
        {/* URL */}
        <div style={{ position: 'absolute', bottom: '30px', color: '#666', fontSize: '18px' }}>
